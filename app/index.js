...
io.on('connection', socket => {
    ...
    socket.on('newDataPoint', body => {
        console.log('new data point received: ' + body.gdp + ',' + body.age + ',' + body.number + ',' + body.country + ',' + body.year);
        socket.broadcast.emit('newDataPoint', {body, from: socket.id.slice(8)});
    });
